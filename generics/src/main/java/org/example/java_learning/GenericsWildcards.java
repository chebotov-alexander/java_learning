...
/*
 Some key points:
   - String, List<Number>, etc - is a concrete type. List<Number> is not a supertype of List<Integer>; they are two independent types, best considered as siblings.
   - <T>, <E>, etc - is a parameterized type or type parameter.
   - <T extends Number>, etc. - is a bounded type parameter.
   - <? extends Number>, <? super Number>, Map<?, ?>, etc - is a wild type aka parameterized type with wildcard arguments.
   ...
   - Wildcard is not a type; it cannot be used in substitutions - it makes no sense to call this.<?>newList(), and it makes no sense to generate a "concrete" List<?> from template List<T>.
...
*/
    ...
    public void invokeCaptureHelperTest() { WildcardCapture.captureHelperTest(); }
}
...
class Boundedwildcards {
    ...
    */
    ...
    // Another example:
    // 1st implementation
    boolean subTypeBoundWildcardExampleFindWithWildcard (List<? extends Employee> l, Employee e) {
        return l.contains(e);
    }
    // 2nd implementation
    <T extends Employee> boolean subTypeBoundWildcardExampleFindWithPlainGeneric (List<T> l, T e) {
        return l.contains(e);
    }
    // 3nd implementation
    <T extends Employee> boolean subTypeBoundWildcardExampleFindWithPlainGenericLoop (List<T> l, T e) {
        boolean result = false;
        for (T eInner : l) {
            result = eInner.equals(e);
        }
        return result;
    }
    void subTypeBoundWildcardExampleTest() {
        ...
        //    (Manager)employeesExtendedEmployeeOfManager, manager1
        //)
...
class WildcardCapture {
    ...
    */
    List<? extends Number> wildcardCaptureGenericMethodSubtype(List<? extends Number> numberList) {
    ...
    void wildcardCaptureSubtype(List<? extends Number> numberList) {
    ...
    */
    ...
    public static void maxminBonus(Manager[] a, Pair<? super Manager> result) {
        ...
        swapHelper(result); // OK--swapHelper captures wildcard type
    }
